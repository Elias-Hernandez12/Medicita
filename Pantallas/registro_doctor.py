...
class RegistroDoctorApp(tk.Frame):
    ...
    def crear_frame_registrar(self):
        ...
        self.label_bienvenida.grid(row=0, column=0, columnspan=3, padx=(70, 50) ,pady=(30, 0), sticky="w")
        ...
        self.label_instruccion.grid(row=1, column=0, columnspan=3, padx=(70, 0) ,pady=10, sticky="w")
        ...
        self.entry_nombre.grid(row=3, column=0, padx=(70, 0), columnspan=3, pady=5, sticky="we", ipady=5)
        ...
        self.entry_correo.grid(row=5, column=0, padx=(70, 0), pady=5, sticky="we", ipady=5)
        ...
        self.entry_cedula.grid(row=5, column=1, padx=(70, 0), columnspan=2, pady=5, sticky="we", ipady=5)
        ...
        self.entry_especialidad.grid(row=7, column=0, padx=(70, 0), pady=5, sticky="we", ipady=5)
        ...
        self.entry_telefono.grid(row=7, column=1, padx=(70, 0), columnspan=2, pady=5, sticky="we", ipady=5)
        ...
        self.entry_contrasena.grid(row=9, column=0, padx=(70, 0), pady=5, sticky="we", ipady=5)
        ...
        self.entry_confirmar_contrasena.grid(row=9, column=1, padx=(70, 0), columnspan=2, pady=5, sticky="we", ipady=5)
        ...
        self.boton_registrarse.grid(row=10, column=0, columnspan=3, padx=(70, 0), pady=10, sticky="we")
